      ...
      children: [
        ...
        Positioned(
          ...
          child: Row(
            ...
            children: [
              // Perubahan warna: Meal ikonnya akan berwarna seperti Drinks
              _buildCategoryItem(Icons.restaurant_menu, 'Meal', Colors.red, Colors.orange.shade100),

              // Perubahan warna: Snack ikonnya akan berwarna dengan kode warna F44336FF
              _buildCategoryItem(Icons.fastfood_outlined, 'Snack', Color(0xFFF44336), Colors.amber),

              _buildCategoryItem(Icons.local_drink_outlined, 'Drinks', Colors.red, Colors.orange.shade100),
            ],
          ),
        ),
      ],
