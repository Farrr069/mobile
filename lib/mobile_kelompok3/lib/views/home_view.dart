      ...
      children: [
        ...
        Positioned(
          ...
          child: Row(
            ...
            children: [
              // Perubahan warna: Meal ikonnya akan tetap seperti sebelumnya
              _buildCategoryItem(Icons.restaurant_menu, 'Meal', Colors.red, Colors.orange.shade100),

              // Snack ikonnya akan mengambil warna seperti Meal (Colors.red)
              _buildCategoryItem(Icons.fastfood_outlined, 'Snack', Colors.red, Colors.orange.shade100),

              // Drinks ikonnya akan mengambil warna seperti Snack (Color(0xFFF44336))
              _buildCategoryItem(Icons.local_drink_outlined, 'Drinks', Color(0xFFF44336), Colors.amber),
            ],
          ),
        ),
      ],
